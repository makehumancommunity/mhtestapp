...
class _ColorTriangleCanvas(Canvas):
    ...
    def __init__(self, parent):
        ...
        super(_ColorTriangleCanvas, self).__init__(parent)
...
class ColorTriangleTest(AbstractTest):

    def __init__(self, parent):
        super().__init__(parent, "Draw a multicolored triangle")

        self.outputWidget = _ColorTriangleCanvas(parent)
